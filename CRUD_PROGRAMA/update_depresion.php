...
$sql="UPDATE escala_depresion (nombre_usuario,zona,distrito,modalidad_atencion,lugar_atencion,edad_anual,edad_meses,fecha_aplicacion) SET ('$nombre_usuario','$zona','$distrito','$modalidad_atencion','$lugar_atencion','$edad_anual','$edad_meses','$fecha_aplicacion')";

$sql2="UPDATE preguntas_escala_depresion (satisfecho_vida,intereses_actividades,vida_vacia,aburrido_frecuentemente,animo_todo_tiempo,preocupado_malo,feliz_tiempo,frecuencia_desamparado,cosas_nuevas,dia_semana_dos,hora_estamos_dos,puntuacion_dos,lugar_estamos,departamento_estamos, barrio_actual,ciudad_estamos,problemas_memoria,maravilloso_vivo,inutil_desprecio,lleno_energia,situacion_actual,total_todo) SET ('$satisfecho_vida','$intereses_actividades','$vida_vacia','$aburrido_frecuentemente','$animo_todo_tiempo','$preocupado_malo','$feliz_tiempo','$frecuencia_desamparado','$cosas_nuevas','$dia_semana_dos','$hora_estamos_dos','$puntuacion_dos','$lugar_estamos','$departamento_estamos', '$barrio_actual','$ciudad_estamos','$problemas_memoria','$maravilloso_vivo','$inutil_desprecio','$lleno_energia','$situacion_actual','$total_todo')";
$sql3="UPDATE datos_funcionario (nombre_funcionario, numero_identificacion_funcionario, cargo, registro_profesional) SET ('$nombre_funcionario','$numero_identificacion_funcionario','$cargo','$registro_profesional')";
