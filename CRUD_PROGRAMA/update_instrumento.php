...
$sql="UPDATE instrumento_programa (fecha_digilenciamiento) SET ('$fecha_digilenciamiento')";

$sql2="UPDATE instrumento_datos_adulto_mayor (nombres_apellidos,sexo,direccion_residencial,barrio,telefono,numero_identificacion,fecha_nacimiento_dia,fecha_nacimiento_mes,fecha_nacimiento_ano,procedencia,lugar,departamento,estado_civil,educacion,profesion,otros_oficios,se_encuentra_afiliado_eps,sisben,cual_sisben,eps,cual_eps,otro_servicio) SET ('$nombres_apellidos','$sexo','$direccion_residencial','$barrio','$telefono','$numero_identificacion','$fecha_nacimiento_dia','$fecha_nacimiento_mes','$fecha_nacimiento_ano','$procedencia','$lugar','$departamento','$estado_civil','$educacion','$profesion','$otros_oficios','$se_encuentra_afiliado_eps','$sisben','$cual_sisben','$eps','$cual_eps','$otro_servicio')";
$sql3="UPDATE instrumento_datos_ambiente_servicios_vivienda (tenencia,otra_tenencia,tipo_vivienda,otro_tipo,numero_identificacion,ruido,iluminacion,ventilacion,humedad,accesibilidad_escaleras,pisos,vias_acceso,transporte) SET ('$tenencia','$otra_tenencia','$tipo_vivienda','$otro_tipo','$numero_identificacion','$ruido','$iluminacion','$ventilacion','$humedad','$accesibilidad_escaleras','$pisos','$vias_acceso', '$transporte')";
$sql4="UPDATE servicios_vivienda (agua,luz,telefono,gas,alcantarillado,material_vivienda) SET ('$agua','$luz','$telefono','$gas','$alcantarillado','$material_vivienda')";
$sql5="UPDATE instrumento_patologias (hipertension,diabetes,enfermedades_cardiacas,osteoporosis,asma,artritis,cancer,demencia, otras) SET ('$hipertension','$diabetes','$enfermedades_cardiacas','$osteoporosis','$asma','$artritis','$cancer','$demencia', '$otras')";
$sql6="UPDATE instrumento_síntomas (dolor_articulaciones,mareos_vahidos,tos_catarro_gripe,tobillos_inflamados,cansancio,dificultad_para_dormir,flojedad_piernas,dificultad_respirar,palpitaciones,dolor_pecho,manos_pies_frios,adormilado,boca_seca,hormigueo_manos_pies) SET ('$dolor_articulaciones','$mareos_vahidos','$tos_catarro_gripe','$tobillos_inflamados','$cansancio','$dificultad_para_dormir','$flojedad_piernas','$dificultad_respirar','$palpitaciones','$dolor_pecho','$manos_pies_frios','$adormilado','$boca_seca','$hormigueo_manos_pies')";
$sql7="UPDATE instrumento_consumo_medicamentos (consume_medicamentos,cuantos_medicamentos,cuales_medicamentos,recibe_tratamiento,cual_tratamiento,frecuencia_visita_medico,otros_datos,medicamentos_no_prescritos, cuales_no_prescritos) SET ('$consume_medicamentos','$cuantos_medicamentos','$cuales_medicamentos','$recibe_tratamiento','$cual_tratamiento','$frecuencia_visita_medico','$otros_datos','$medicamentos_no_prescritos', '$cuales_no_prescritos')";
$sql8="UPDATE instrumento_habitos_adulto_mayor (cambio_habitos_alimenticios,come_menos_dos_veces,tiene_problemas_dentales,come_pocas_frutas,come_solo,realiza_ejercicio,frecuencia_realiza_ejercicio,fuma,cuantos_cigarrillos,consume_licor, frecuencia_consume_licor,cantidad_consume_licor) SET ('$cambio_habitos_alimenticios','$come_menos_dos_veces','$tiene_problemas_dentales','$come_pocas_frutas','$come_solo','$realiza_ejercicio','$frecuencia_realiza_ejercicio','$fuma','$cuantos_cigarrillos','$consume_licor', '$frecuencia_consume_licor','$cantidad_consume_licor')";
$sql9="UPDATE instrumento_funcionalidad_adulto_mayor (cuidar_aspecto_fisico,realizar_tareas_caseras,caminar,realizar_tareas_fuera,puede_valerse) SET ('$cuidar_aspecto_fisico','$realizar_tareas_caseras','$caminar','$realizar_tareas_fuera','$puede_valerse')";
$sql10="UPDATE instrumento_longevidad_adulto_mayor (parientes_longevos,edad_madre_padre,edad_abuelo_abuela,edad_tio_tia) SET ('$parientes_longevos','$edad_madre_padre','$edad_abuelo_abuela','$edad_tio_tia')";
$sql11="UPDATE ficha_psicologia_adulto_mayor (siente_deprimido,siente_desesperado,olvida_dia_que_se_encuentra,olvida_oficios,olvida_objetos_personales,se_pierde_en_algun_lugar,falta_interes,preocupa_higiene_personal,satisfecho_como_ocupa_eltiempo,esta_satisfecho_con_la_vida,observaciones) SET ('$siente_deprimido','$siente_desesperado','$olvida_dia_que_se_encuentra','$olvida_oficios','$olvida_objetos_personales','$se_pierde_en_algun_lugar','$falta_interes','$preocupa_higiene_personal','$satisfecho_como_ocupa_eltiempo','$esta_satisfecho_con_la_vida','$observaciones')";
$sql12="UPDATE relaciones_familiares (personas_viven,con_quien_vive,tuvo_hijos,cuantos_hijos,rol_nucleo_familiar,actividades_que_participa,otras_actividades,participa_en_decisiones,como_participa,mencione_participacion,que_aportes_recibe,otros_aportes,esta_satisfecho,por_que_satisfecho,comunicacion_con_quien_vive,por_que_comunica,como_califica_relaciones,por_que_relaciona) SET ('$personas_viven','$con_quien_vive','$tuvo_hijos','$cuantos_hijos','$rol_nucleo_familiar','$actividades_que_participa','$otras_actividades','$participa_en_decisiones','$como_participa','$mencione_participacion','$que_aportes_recibe', '$otros_aportes','$esta_satisfecho','$por_que_satisfecho','$comunicacion_con_quien_vive','$por_que_comunica','$como_califica_relaciones','$por_que_relaciona')";
$sql13="UPDATE relaciones_interpersonales (hijos_que_no_viven_con_usted,nietos_que_no_viven_con_usted,familiares_no_viven_con_usted,vecinos,amigos_no_vecinos, conyuge,hijos,nietos,otros_familiares,vecinos,amigos_no_vecinos) SET ('$hijos_que_no_viven_con_usted','$nietos_que_no_viven_con_usted','$familiares_no_viven_con_usted','$vecinos', '$amigos_no_vecinos', '$conyuge','$hijos','$nietos','$otros_familiares','$vecinos','$amigos_no_vecinos')";
$sql14="UPDATE relaciones_social (participa_en_grupos,cuales_grupos,con_que_frecuencia,nunca_explique_razones) SET ('$participa_en_grupos','$cuales_grupos','$con_que_frecuencia','$nunca_explique_razones')";

$sql15="UPDATE instrumento_actividad_ocio_adulto_mayor (trabajado_durante_su_vida, labora_actualmente,cual_actividad,leer,visitar_amigos,ver_television,escuchar_radio,caminar,juegos_actividades,cuidar_ninos,hacer_manualidades,hacer_mandados,ir_compras,viajar,observaciones_generales,impresion_diagnostica,concepto_gerontologico,plan) SET ('$trabajado_durante_su_vida', '$labora_actualmente','$cual_actividad','$leer','$visitar_amigos','$ver_television','$escuchar_radio','$caminar','$juegos_actividades','$cuidar_ninos','$hacer_manualidades','$hacer_mandados','$ir_compras','$viajar','$observaciones_generales','$impresion_diagnostica','$concepto_gerontologico','$plan')";
$sql16="UPDATE datos_funcionario (nombre_funcionario, numero_identificacion_funcionario, cargo, registro_profesional) SET ('$nombre_funcionario','$numero_identificacion_funcionario','$cargo','$registro_profesional')";
